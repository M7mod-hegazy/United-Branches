      ...
      <div className="overflow-x-auto">
        <table className="min-w-full border-collapse text-right">
          ...
          <tbody className="divide-y divide-slate-100">
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="flex items-center gap-2 mt-2 flex-wrap">
                        <span className="inline-flex items-center gap-1 rounded-lg px-2.5 py-0.5 text-[9px] font-black bg-blue-50/50 text-[#1E6FBF] border border-blue-100/30 leading-none whitespace-nowrap">
                        ...
                        <span className="inline-flex items-center gap-1 rounded-lg px-2.5 py-0.5 text-[9px] font-black bg-slate-50 text-slate-400 border border-slate-200/50 leading-none whitespace-nowrap">
                          <svg className="h-2.5 w-2.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {products.length === 0 && (
              <tr>
                <td colSpan={branches.length + 3 + (showSellingPrice || showBuyingPrice ? branches.length : 0)} className="py-24 text-center text-slate-400 font-extrabold text-sm">
